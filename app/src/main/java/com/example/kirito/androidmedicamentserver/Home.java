...
import com.example.kirito.androidmedicamentserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Inicamos el almacenamiento de FIREBASE
        ...
        //Ponemos el nombre del usuario activo en la app
        View headerView = navigationView.getHeaderView(0);
        txtFullName = (TextView)headerView.findViewById(R.id.txtFullName);
        txtFullName.setText(Common.currentUser.getName());

        //Iniciamos la vista(VIew)
        ...
        alertDialog.setPositiveButton("SI", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int which) {
                ...
                if(newCategory != null){
                    ...
                    Snackbar.make(drawer, "Nueva Categoria "+newCategory.getName()+ " Fue adicionada", Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(Home.this, "Cargado!!!", Toast.LENGTH_SHORT).show();
    ...
    //Presiono Ctrl + o (ayuda memoria de atajos)
    ...
    private void loadMenu() {
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                //Para ver la opciones de ACTUALIZAR(UPDATE) o BORRAR(DELETE)
    ...
    //Funciones AACTUALIZAR o BORRAR cuando se presiona constante en la img
    //presionamos Ctrl + O
    ...
    private void deleteCategory(String key) {
        ...
        Toast.makeText(this, "Categoria Borrada!!!", Toast.LENGTH_SHORT).show();
    }
    ...
    private void showUpdateDialog(final String key, final Category item) {
            ...
            //Inicalizamos el nombre por defecto de la categoria
            ...
            alertDialog.setPositiveButton("SI", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int which) {
                    ...
                    //Actualizamos la informacion de la imagen....NOMBRE
    ...
    //funcion para cambiar la imagem por la nueva selecionada
